                    ...
                    <div class="card card-widget">
                      <div class="card-header">
                        <div class="user-block">
                          <img class="img-circle" src="http://15.206.249.190/api/uploads/users_profile_img/`+ data.data[i].user_id.img + `" alt="UserImage">
                      ...
                      <div class="card-body">
                       <img class="img-fluid pad" src="http://15.206.249.190/api/uploads/users_posts_img/`+ data.data[i].post_img +`"><hr>
                        <p>`+data.data[i].post_data +`</p>
