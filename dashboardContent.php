<div class="row"> 
            ...
            <a href="user.php" class="nav-link" style="text-decoration: none;color:black;" >
              <div class="small-box" style="background-color:#008080">
              <div class="icon">
                      <i class="fas fas fa-users" style="color:lightgreen"></i>
                  </div>
                <div class="inner">
            ...
            <div class="col-lg-4 col-6">
            <a href="post.php" class="nav-link" style="text-decoration: none;color:black;" >
              <div class="small-box" style="background-color:#008080">
              <div class="icon">
                      <i class="fas fa-sticky-note" style="color:lightgreen"></i>
                  </div>
                <div class="inner">
            ...
            <div class="col-lg-4 col-6">
              <a href="block_user.php" class="nav-link" style="text-decoration: none;color:black;" >
                <div class="small-box" style="background-color:#008080">
                  <div class="icon">
                        <i class="fa fa-ban" style="color:lightgreen"></i>
                  </div>
                  <div class="inner">
          ...
          <hr>
          <h5><b> Message , Likes & Comments Detail</b></h5>
          <div class="row">

            <div class="col-lg-4 col-6">
            <a href="message.php" class="nav-link" style="text-decoration: none;color:black;">
                <div class="small-box shadow" style="background-color:#008080">
                  <div class="icon">
                      <i class="fa fa-envelope" style="color:lightgreen"></i>
                  </div>
                  <div class="inner">
            ...
            <div class="col-lg-4 col-6">
            <a href="likes.php" class="nav-link" style="text-decoration: none;color:black;">
                <div class="small-box shadow" style="background-color:#008080">
                <div class="icon">
                      <i class="fa fa-thumbs-up" style="color:lightgreen"></i>
                  </div>
                  <div class="inner">
                    <h3><label  id="likestab" name="likestab" value="0">12</label></h3>
                    <h5><b>Likes</b></h5>
                  </div>
                </div>
            </a>
          ...
          <div class="row">
              ...
              <a href="state.php" class="nav-link" style="text-decoration: none;color:black;">
                  <div class="small-box shadow" style="background-color:#008080">
                    <div class="icon">
                        <i class="fa fa-map-marker" style="color:lightgreen"></i>
                    </div>
                    <div class="inner">
                    <h3><label  id="state" name="state" value="37">37</label></h3>
                    <h5><b>State</b>
                      <ul class="pt-2">
                      <!-- <a href="employee.php"><li class="text-dark p-1">Employee Manage</li></a> -->
              ...
              <a href="city.php" class="nav-link" style="text-decoration: none;color:black;">
                  <div class="small-box shadow" style="background-color:#008080">
                    <div class="icon">
                        <i class="fas fa-city" style="color:lightgreen"></i>
                    </div>
                    <div class="inner">
                    <h3><label  id="city" name="city" value="1">1</label></h3>
                    <h5><b>City</b>
                      <ul class="pt-2">
                      <!-- <a href="employee.php"><li class="text-dark p-1">Employee Manage</li></a> -->
                      <!-- <a href="employee.php"><li class="text-dark p-1">Add Employee</li></a> -->
              ...
              <a href="city.php" class="nav-link" style="text-decoration: none;color:black;">
                  <div class="small-box shadow" style="background-color:#008080">
                    <div class="icon">
                        <i class="fas fa-city" style="color:#00FF7F"></i>
                    </div>
                    <div class="inner">
                      <h5><b>City</b>
                    <h3><label  id="city" name="city" value="0">1</label></h3>
                      <ul class="pt-1"> -->
